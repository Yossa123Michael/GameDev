...
export type CreditCategory = { title: string; layout?: 'single' | 'two-column'; items: CreditItem[]; };

const credits: CreditCategory[] = [
  { title: 'Creator', layout: 'single', items: [{ label: 'Creator', name: 'Yossa Michael', url: 'https://twitter.com/Yossa123Michael' }] },
  { title: 'Backsound Artist', layout: 'two-column', items: [
  ...
  { title: 'Sound Effect Artist', layout: 'two-column', items: [
