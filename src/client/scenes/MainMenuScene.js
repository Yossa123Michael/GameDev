...
export class MainMenuScene extends BaseScene {
    ...
    draw() {
        ...
        const startButton = this.createButton(currentButtonY, 'Start Test', () => this.scene.start('PilihModeScene'));
        currentButtonY += buttonSpacing;
        const leaderboardButton = this.createButton(currentButtonY, 'Leaderboard', () => this.scene.start('LeaderboardScene'));
        currentButtonY += buttonSpacing;
        const achievementButton = this.createButton(currentButtonY, 'Achievment', () => this.scene.start('AchievementScene'));
        currentButtonY += buttonSpacing;
        const optionButton = this.createButton(currentButtonY, 'Option', () => this.scene.start('OptionScene'));
        currentButtonY += buttonSpacing;
